...
namespace Sukellos\WPFw\AdminBuilder\Inc;
...
class EDD_SL_Plugin_Updater {
    ...
    private $use_basic_authorization;
    private $basic_authorization_name;
    private $basic_authorization_password;
	...
	public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
        ...
        $this->use_basic_authorization  = ( array_key_exists( 'use_basic_authorization', $_api_data ) ? $_api_data['use_basic_authorization'] : false );
        $this->basic_authorization_name  = ( array_key_exists( 'basic_authorization_name', $_api_data ) ? $_api_data['basic_authorization_name'] : '' );
        $this->basic_authorization_password  = ( array_key_exists( 'basic_authorization_password', $_api_data ) ? $_api_data['basic_authorization_password'] : '' );
	...
	private function get_version_from_remote() {
        ...
        $auth_header = array();
        if ( $this->use_basic_authorization ) {

            $auth_header[ 'Authorization' ] = 'Basic ' . base64_encode( $this->basic_authorization_name.':'.$this->basic_authorization_password );
        }
